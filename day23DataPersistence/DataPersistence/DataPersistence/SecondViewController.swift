...
class SecondViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func loadData(){
        let recipeRequest:NSFetchRequest<DataPersistence> = DataPersistence.fetchRequest()
        do {
...
@IBAction func addRecipeButtonTapped(_ sender: Any) {
    ...
    let recipeItem = DataPersistence(context: managedObjectContext)
